function recall=knearestrecall(I,lastobjectid,maxeigenvector,isTraining,lnormpower,numberofneighbours)%,ind,numberofsubjects,numberofobjects,maxind,svmRecall)
%function res=knearestrecall(I,lastobjectid,maxeigenvector,isTraining,lnormpower,numberofneighbours,ind,numberofsubjects,numberofobjects,maxind,svmRecall)
    ...
    for dimension=1:numberoffeatures;
        ...
        recall(dimension)=positive/totalpositive;
        %%%%
        %
